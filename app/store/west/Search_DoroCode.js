Ext.define('InAcc.store.west.Search_DoroCode', {
	...
	listeners: {
		load: function(store) {
			...
			var adm_cd = Ext.getCmp("cmd_doro_sigungu").value;
			var cmd_doro = Ext.getCmp("cmd_doro").value;
			var cmd_doro_num = Ext.getCmp("cmd_doro_num").value;
			
			Ext.Ajax.request({
        		url: './resources/jsp/searchResult/searchDoro.jsp',
        		params: {adm_cd : adm_cd, cmd_doro: cmd_doro, cmd_doro_num: cmd_doro_num},
